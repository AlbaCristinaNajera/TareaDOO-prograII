...
public class Bogota extends Sucursal{

    public Bogota(String nombre, String direccion) {
    ...
    public void agregarIngrediente() {
        ...
        switch (tipo.toLowerCase()) {
            ...
            case "granos":
                ...
                break;
            case "leche":
                System.out.println("¿Desea agregar leche? (sí/no)");
                String respuesta = scanner.nextLine().trim().toLowerCase();
                if (respuesta.equals("sí") || respuesta.equals("si")) {
                    System.out.println("Ingrese el tipo de leche:");
                    String tipoLeche = scanner.nextLine();

                    System.out.println("Ingrese la cantidad de leche (en ml):");
                    int cantidadLeche = scanner.nextInt();
                    scanner.nextLine(); // Consumir la nueva línea

                    Leche leche = new Leche(tipoLeche, cantidadLeche);
                    this.getIngredientes().add(leche);
                    System.out.println("Leche agregada exitosamente.");
                } else {
                    System.out.println("No se agregará leche.");
                }
                break;
            default:
